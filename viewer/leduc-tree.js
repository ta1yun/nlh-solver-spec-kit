...
(function() {
  ...
  j: {
      ...
      actions: ["check", "bet"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: 0.82, evRange: 2.22, rangeWeight: 0.12, freq: {check: 1.00, bet: 0.00}, ev: {check: 0.83, bet: -0.10}, evA: {check: 2.22, bet: 1.22} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: 0.82, evRange: 2.22, rangeWeight: 0.12, freq: {check: 1.00, bet: 0.00}, ev: {check: 0.83, bet: -0.10}, evA: {check: 2.22, bet: 1.22} },
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -2.68, evRange: -2.63, rangeWeight: 0.35, freq: {check: 0.98, bet: 0.02}, ev: {check: -2.67, bet: -3.22}, evA: {check: -2.63, bet: -2.67} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -2.68, evRange: -2.63, rangeWeight: 0.35, freq: {check: 0.98, bet: 0.02}, ev: {check: -2.67, bet: -3.22}, evA: {check: -2.63, bet: -2.67} },
        { id: "Jb", label: "J♥", equity: 1.00, evUniform: 4.53, evRange: 4.62, rangeWeight: 0.05, freq: {check: 0.15, bet: 0.85}, ev: {check: 4.65, bet: 4.51}, evA: {check: 4.61, bet: 4.62} },
      ],
      children: {
        check: {
      meta: { round: 2, pot: 6, toCall: 0, board: ["J♠"] },
      actions: ["check", "bet"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: 0.47, evRange: 2.16, rangeWeight: 0.25, freq: {check: 0.86, bet: 0.14}, ev: {check: 0.75, bet: -1.21}, evA: {check: 1.92, bet: 1.79} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: 0.47, evRange: 2.16, rangeWeight: 0.25, freq: {check: 0.86, bet: 0.14}, ev: {check: 0.75, bet: -1.21}, evA: {check: 1.92, bet: 1.79} },
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -3.47, evRange: -1.52, rangeWeight: 0.21, freq: {check: 0.46, bet: 0.54}, ev: {check: -2.25, bet: -4.52}, evA: {check: -1.50, bet: -1.64} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -3.47, evRange: -1.52, rangeWeight: 0.21, freq: {check: 0.46, bet: 0.54}, ev: {check: -2.25, bet: -4.52}, evA: {check: -1.50, bet: -1.64} },
        { id: "Jb", label: "J♥", equity: 1.00, evUniform: 5.03, evRange: 4.09, rangeWeight: 0.08, freq: {check: 0.00, bet: 1.00}, ev: {check: 3.00, bet: 5.03}, evA: {check: 2.84, bet: 4.09} },
      ],
      children: {
        check: { terminal: true, outcome: 'showdown' },
        bet: {
      ...
      actions: ["fold", "call", "raise"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: 1.75, evRange: 3.26, rangeWeight: 0.12, freq: {fold: 0.00, call: 1.00, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 0.76}, evA: {fold: -3.00, call: 2.33, raise: 2.88} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: 1.75, evRange: 3.26, rangeWeight: 0.12, freq: {fold: 0.00, call: 1.00, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 0.76}, evA: {fold: -3.00, call: 2.33, raise: 2.88} },
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -3.03, evRange: -3.03, rangeWeight: 0.35, freq: {fold: 0.99, call: 0.00, raise: 0.01}, ev: {fold: -3.00, call: -5.25, raise: -6.50}, evA: {fold: -3.00, call: -5.27, raise: -6.13} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -3.03, evRange: -3.03, rangeWeight: 0.35, freq: {fold: 0.99, call: 0.00, raise: 0.01}, ev: {fold: -3.00, call: -5.25, raise: -6.50}, evA: {fold: -3.00, call: -5.27, raise: -6.13} },
        { id: "Jb", label: "J♥", equity: 1.00, evUniform: 9.01, evRange: 9.16, rangeWeight: 0.05, freq: {fold: 0.00, call: 0.00, raise: 1.00}, ev: {fold: -3.00, call: 7.00, raise: 9.01}, evA: {fold: -3.00, call: 6.47, raise: 9.16} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["fold", "call"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: 2.74, evRange: 8.11, rangeWeight: 0.25, freq: {fold: 0.00, call: 1.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: 7.04} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: 2.74, evRange: 8.11, rangeWeight: 0.25, freq: {fold: 0.00, call: 1.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: 7.04} },
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -7.01, evRange: -6.99, rangeWeight: 0.21, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -5.51} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -7.01, evRange: -6.99, rangeWeight: 0.21, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -5.51} },
        { id: "Jb", label: "J♥", equity: 1.00, evUniform: 11.00, evRange: 11.00, rangeWeight: 0.08, freq: {fold: 0.00, call: 1.00}, ev: {fold: -7.00, call: 11.00}, evA: {fold: -7.00, call: 10.42} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["check", "bet"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -0.45, evRange: -1.32, rangeWeight: 0.17, freq: {check: 0.08, bet: 0.92}, ev: {check: -0.02, bet: -0.48}, evA: {check: -1.31, bet: -1.32} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -0.45, evRange: -1.32, rangeWeight: 0.17, freq: {check: 0.08, bet: 0.92}, ev: {check: -0.02, bet: -0.48}, evA: {check: -1.31, bet: -1.32} },
        { id: "Qb", label: "Q♥", equity: 1.00, evUniform: 4.38, evRange: 4.55, rangeWeight: 0.50, freq: {check: 0.01, bet: 0.99}, ev: {check: 4.53, bet: 4.38}, evA: {check: 4.49, bet: 4.55} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -1.94, evRange: -2.50, rangeWeight: 0.08, freq: {check: 0.01, bet: 0.99}, ev: {check: -2.25, bet: -1.93}, evA: {check: -2.74, bet: -2.50} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -1.94, evRange: -2.50, rangeWeight: 0.08, freq: {check: 0.01, bet: 0.99}, ev: {check: -2.25, bet: -1.93}, evA: {check: -2.74, bet: -2.50} },
      ],
      children: {
        check: {
      meta: { round: 2, pot: 6, toCall: 0, board: ["Q♠"] },
      actions: ["check", "bet"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -0.38, evRange: -2.37, rangeWeight: 0.29, freq: {check: 0.65, bet: 0.35}, ev: {check: 0.75, bet: -2.52}, evA: {check: -1.92, bet: -4.48} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -0.38, evRange: -2.37, rangeWeight: 0.29, freq: {check: 0.65, bet: 0.35}, ev: {check: 0.75, bet: -2.52}, evA: {check: -1.92, bet: -4.48} },
        { id: "Qb", label: "Q♥", equity: 1.00, evUniform: 6.39, evRange: 5.92, rangeWeight: 0.25, freq: {check: 0.00, bet: 1.00}, ev: {check: 3.00, bet: 6.39}, evA: {check: 1.50, bet: 5.92} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -2.81, evRange: -3.62, rangeWeight: 0.09, freq: {check: 0.61, bet: 0.39}, ev: {check: -2.25, bet: -3.67}, evA: {check: -2.84, bet: -4.96} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -2.81, evRange: -3.62, rangeWeight: 0.09, freq: {check: 0.61, bet: 0.39}, ev: {check: -2.25, bet: -3.67}, evA: {check: -2.84, bet: -4.96} },
      ],
      children: {
        check: { terminal: true, outcome: 'showdown' },
        bet: {
      ...
      actions: ["fold", "call", "raise"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -0.39, evRange: -1.74, rangeWeight: 0.17, freq: {fold: 0.45, call: 0.55, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 2.42}, evA: {fold: -3.00, call: -2.33, raise: 0.59} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -0.39, evRange: -1.74, rangeWeight: 0.17, freq: {fold: 0.45, call: 0.55, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 2.42}, evA: {fold: -3.00, call: -2.33, raise: 0.59} },
        { id: "Qb", label: "Q♥", equity: 1.00, evUniform: 7.14, evRange: 7.19, rangeWeight: 0.50, freq: {fold: 0.00, call: 0.00, raise: 1.00}, ev: {fold: -3.00, call: 7.00, raise: 7.14}, evA: {fold: -3.00, call: 5.27, raise: 7.19} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -0.18, evRange: -0.47, rangeWeight: 0.08, freq: {fold: 0.43, call: 0.00, raise: 0.57}, ev: {fold: -3.00, call: -5.25, raise: 1.95}, evA: {fold: -3.00, call: -6.47, raise: 1.45} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -0.18, evRange: -0.47, rangeWeight: 0.08, freq: {fold: 0.43, call: 0.00, raise: 0.57}, ev: {fold: -3.00, call: -5.25, raise: 1.95}, evA: {fold: -3.00, call: -6.47, raise: 1.45} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["fold", "call"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -6.42, evRange: -6.86, rangeWeight: 0.29, freq: {fold: 0.94, call: 0.06}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -7.04} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -6.42, evRange: -6.86, rangeWeight: 0.29, freq: {fold: 0.94, call: 0.06}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -7.04} },
        { id: "Qb", label: "Q♥", equity: 1.00, evUniform: 11.00, evRange: 11.00, rangeWeight: 0.25, freq: {fold: 0.00, call: 1.00}, ev: {fold: -7.00, call: 11.00}, evA: {fold: -7.00, call: 5.51} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -7.01, evRange: -7.03, rangeWeight: 0.09, freq: {fold: 0.99, call: 0.01}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.42} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -7.01, evRange: -7.03, rangeWeight: 0.09, freq: {fold: 0.99, call: 0.01}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.42} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["check", "bet"],
      hands: [
        { id: "Kb", label: "K♥", equity: 1.00, evUniform: 4.57, evRange: 4.39, rangeWeight: 0.13, freq: {check: 0.91, bet: 0.09}, ev: {check: 4.64, bet: 3.97}, evA: {check: 4.39, bet: 4.38} },
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: -0.01, evRange: -1.58, rangeWeight: 0.38, freq: {check: 0.99, bet: 0.01}, ev: {check: -0.01, bet: 0.09}, evA: {check: -1.58, bet: -1.59} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: -0.01, evRange: -1.58, rangeWeight: 0.38, freq: {check: 0.99, bet: 0.01}, ev: {check: -0.01, bet: 0.09}, evA: {check: -1.58, bet: -1.59} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -2.62, evRange: -2.87, rangeWeight: 0.06, freq: {check: 0.97, bet: 0.03}, ev: {check: -2.65, bet: -1.81}, evA: {check: -2.86, bet: -2.92} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -2.62, evRange: -2.87, rangeWeight: 0.06, freq: {check: 0.97, bet: 0.03}, ev: {check: -2.65, bet: -1.81}, evA: {check: -2.86, bet: -2.92} },
      ],
      children: {
        check: {
      meta: { round: 2, pot: 6, toCall: 0, board: ["K♠"] },
      actions: ["check", "bet"],
      hands: [
        { id: "Kb", label: "K♥", equity: 1.00, evUniform: 4.14, evRange: 4.95, rangeWeight: 0.30, freq: {check: 0.00, bet: 1.00}, ev: {check: 3.00, bet: 4.14}, evA: {check: 2.60, bet: 4.95} },
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: 0.56, evRange: -0.10, rangeWeight: 0.26, freq: {check: 0.72, bet: 0.28}, ev: {check: 0.75, bet: 0.06}, evA: {check: -0.60, bet: -0.15} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: 0.56, evRange: -0.10, rangeWeight: 0.26, freq: {check: 0.72, bet: 0.28}, ev: {check: 0.75, bet: 0.06}, evA: {check: -0.60, bet: -0.15} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -2.28, evRange: -2.85, rangeWeight: 0.09, freq: {check: 0.46, bet: 0.54}, ev: {check: -2.25, bet: -2.31}, evA: {check: -2.84, bet: -2.88} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -2.28, evRange: -2.85, rangeWeight: 0.09, freq: {check: 0.46, bet: 0.54}, ev: {check: -2.25, bet: -2.31}, evA: {check: -2.84, bet: -2.88} },
      ],
      children: {
        check: { terminal: true, outcome: 'showdown' },
        bet: {
      ...
      actions: ["fold", "call", "raise"],
      hands: [
        { id: "Kb", label: "K♥", equity: 1.00, evUniform: 7.01, evRange: 7.01, rangeWeight: 0.13, freq: {fold: 0.00, call: 0.00, raise: 1.00}, ev: {fold: -3.00, call: 7.00, raise: 7.01}, evA: {fold: -3.00, call: 4.89, raise: 7.01} },
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: -0.34, evRange: -1.95, rangeWeight: 0.38, freq: {fold: 0.44, call: 0.56, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 2.50}, evA: {fold: -3.00, call: -2.82, raise: -0.33} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: -0.34, evRange: -1.95, rangeWeight: 0.38, freq: {fold: 0.44, call: 0.56, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 2.50}, evA: {fold: -3.00, call: -2.82, raise: -0.33} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -2.98, evRange: -2.99, rangeWeight: 0.06, freq: {fold: 1.00, call: 0.00, raise: 0.00}, ev: {fold: -3.00, call: -5.25, raise: 2.47}, evA: {fold: -3.00, call: -6.47, raise: 0.99} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -2.98, evRange: -2.99, rangeWeight: 0.06, freq: {fold: 1.00, call: 0.00, raise: 0.00}, ev: {fold: -3.00, call: -5.25, raise: 2.47}, evA: {fold: -3.00, call: -6.47, raise: 0.99} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["fold", "call"],
      hands: [
        { id: "Kb", label: "K♥", equity: 1.00, evUniform: 11.00, evRange: 11.00, rangeWeight: 0.30, freq: {fold: 0.00, call: 1.00}, ev: {fold: -7.00, call: 11.00}, evA: {fold: -7.00, call: 9.55} },
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: -6.97, evRange: -6.98, rangeWeight: 0.26, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -2.19} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: -6.97, evRange: -6.98, rangeWeight: 0.26, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -2.19} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.09, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.42} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.09, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.42} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      hands: [
        ...
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -2.26, evRange: -1.82, rangeWeight: 0.24, freq: {check: 0.99, bet: 0.01}, ev: {check: -2.25, bet: -3.36}, evA: {check: -1.82, bet: -1.87} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -2.26, evRange: -1.82, rangeWeight: 0.24, freq: {check: 0.99, bet: 0.01}, ev: {check: -2.25, bet: -3.36}, evA: {check: -1.82, bet: -1.87} },
        { id: "Jb", label: "J♥", equity: 1.00, evUniform: 4.62, evRange: 4.32, rangeWeight: 0.02, freq: {check: 0.02, bet: 0.98}, ev: {check: 4.68, bet: 4.62}, evA: {check: 4.34, bet: 4.32} },
      ],
      children: {
        check: {
      meta: { round: 2, pot: 6, toCall: 0, board: ["J♠"] },
      actions: ["check", "bet"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -0.08, evRange: 1.71, rangeWeight: 0.19, freq: {check: 0.57, bet: 0.43}, ev: {check: 0.75, bet: -1.18}, evA: {check: 1.66, bet: 1.57} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -0.08, evRange: 1.71, rangeWeight: 0.19, freq: {check: 0.57, bet: 0.43}, ev: {check: 0.75, bet: -1.18}, evA: {check: 1.66, bet: 1.57} },
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -2.26, evRange: -2.06, rangeWeight: 0.28, freq: {check: 1.00, bet: 0.00}, ev: {check: -2.25, bet: -4.48}, evA: {check: -2.08, bet: -3.82} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -2.26, evRange: -2.06, rangeWeight: 0.28, freq: {check: 1.00, bet: 0.00}, ev: {check: -2.25, bet: -4.48}, evA: {check: -2.08, bet: -3.82} },
        { id: "Jb", label: "J♥", equity: 1.00, evUniform: 4.99, evRange: 5.03, rangeWeight: 0.06, freq: {check: 0.00, bet: 1.00}, ev: {check: 3.00, bet: 4.99}, evA: {check: 2.93, bet: 5.03} },
      ],
      children: {
        check: { terminal: true, outcome: 'showdown' },
        bet: {
      ...
      actions: ["fold", "call", "raise"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: 1.73, evRange: 4.36, rangeWeight: 0.25, freq: {fold: 0.00, call: 1.00, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 0.87}, evA: {fold: -3.00, call: 3.65, raise: 4.23} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: 1.73, evRange: 4.36, rangeWeight: 0.25, freq: {fold: 0.00, call: 1.00, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 0.87}, evA: {fold: -3.00, call: 3.65, raise: 4.23} },
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -3.00, evRange: -3.00, rangeWeight: 0.24, freq: {fold: 1.00, call: 0.00, raise: 0.00}, ev: {fold: -3.00, call: -5.25, raise: -5.90}, evA: {fold: -3.00, call: -4.43, raise: -3.26} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -3.00, evRange: -3.00, rangeWeight: 0.24, freq: {fold: 1.00, call: 0.00, raise: 0.00}, ev: {fold: -3.00, call: -5.25, raise: -5.90}, evA: {fold: -3.00, call: -4.43, raise: -3.26} },
        { id: "Jb", label: "J♥", equity: 1.00, evUniform: 8.87, evRange: 8.49, rangeWeight: 0.02, freq: {fold: 0.00, call: 0.00, raise: 1.00}, ev: {fold: -3.00, call: 7.00, raise: 8.87}, evA: {fold: -3.00, call: 6.60, raise: 8.50} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["fold", "call"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: 2.10, evRange: 5.74, rangeWeight: 0.19, freq: {fold: 0.07, call: 0.93}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: 6.10} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: 2.10, evRange: 5.74, rangeWeight: 0.19, freq: {fold: 0.07, call: 0.93}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: 6.10} },
        { id: "Qa", label: "Q♠", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.28, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -7.64} },
        { id: "Qb", label: "Q♥", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.28, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -7.64} },
      ...
      actions: ["check", "bet"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -0.27, evRange: -2.04, rangeWeight: 0.32, freq: {check: 1.00, bet: 0.00}, ev: {check: -0.27, bet: 0.25}, evA: {check: -2.04, bet: -2.16} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -0.27, evRange: -2.04, rangeWeight: 0.32, freq: {check: 1.00, bet: 0.00}, ev: {check: -0.27, bet: 0.25}, evA: {check: -2.04, bet: -2.16} },
        { id: "Qb", label: "Q♥", equity: 1.00, evUniform: 4.29, evRange: 3.95, rangeWeight: 0.31, freq: {check: 0.48, bet: 0.52}, ev: {check: 5.00, bet: 3.62}, evA: {check: 3.95, bet: 3.94} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -1.04, evRange: -2.56, rangeWeight: 0.03, freq: {check: 0.01, bet: 0.99}, ev: {check: -2.98, bet: -1.03}, evA: {check: -3.07, bet: -2.55} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -1.04, evRange: -2.56, rangeWeight: 0.03, freq: {check: 0.01, bet: 0.99}, ev: {check: -2.98, bet: -1.03}, evA: {check: -3.07, bet: -2.55} },
      ],
      children: {
        check: {
      meta: { round: 2, pot: 6, toCall: 0, board: ["Q♠"] },
      actions: ["check", "bet"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: 0.74, evRange: -1.08, rangeWeight: 0.24, freq: {check: 0.99, bet: 0.01}, ev: {check: 0.75, bet: -0.02}, evA: {check: -1.66, bet: -2.19} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: 0.74, evRange: -1.08, rangeWeight: 0.24, freq: {check: 0.99, bet: 0.01}, ev: {check: 0.75, bet: -0.02}, evA: {check: -1.66, bet: -2.19} },
        { id: "Qb", label: "Q♥", equity: 1.00, evUniform: 4.11, evRange: 4.83, rangeWeight: 0.37, freq: {check: 0.00, bet: 1.00}, ev: {check: 3.00, bet: 4.11}, evA: {check: 2.08, bet: 4.83} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -2.05, evRange: -3.39, rangeWeight: 0.07, freq: {check: 0.01, bet: 0.99}, ev: {check: -2.25, bet: -2.05}, evA: {check: -2.93, bet: -3.39} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -2.05, evRange: -3.39, rangeWeight: 0.07, freq: {check: 0.01, bet: 0.99}, ev: {check: -2.25, bet: -2.05}, evA: {check: -2.93, bet: -3.39} },
      ],
      children: {
        check: { terminal: true, outcome: 'showdown' },
        bet: {
      ...
      actions: ["fold", "call", "raise"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -0.65, evRange: -2.52, rangeWeight: 0.32, freq: {fold: 0.51, call: 0.49, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 2.49}, evA: {fold: -3.00, call: -3.65, raise: -1.72} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -0.65, evRange: -2.52, rangeWeight: 0.32, freq: {fold: 0.51, call: 0.49, raise: 0.00}, ev: {fold: -3.00, call: 1.75, raise: 2.49}, evA: {fold: -3.00, call: -3.65, raise: -1.72} },
        { id: "Qb", label: "Q♥", equity: 1.00, evUniform: 7.01, evRange: 7.01, rangeWeight: 0.31, freq: {fold: 0.00, call: 0.00, raise: 1.00}, ev: {fold: -3.00, call: 7.00, raise: 7.01}, evA: {fold: -3.00, call: 4.43, raise: 7.01} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -2.84, evRange: -2.92, rangeWeight: 0.03, freq: {fold: 0.97, call: 0.00, raise: 0.03}, ev: {fold: -3.00, call: -5.25, raise: 2.47}, evA: {fold: -3.00, call: -6.60, raise: -0.16} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -2.84, evRange: -2.92, rangeWeight: 0.03, freq: {fold: 0.97, call: 0.00, raise: 0.03}, ev: {fold: -3.00, call: -5.25, raise: 2.47}, evA: {fold: -3.00, call: -6.60, raise: -0.16} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["fold", "call"],
      hands: [
        { id: "Ka", label: "K♠", equity: 0.63, evUniform: -6.96, evRange: -6.99, rangeWeight: 0.24, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -6.10} },
        { id: "Kb", label: "K♥", equity: 0.63, evUniform: -6.96, evRange: -6.99, rangeWeight: 0.24, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -6.10} },
        ...
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.07, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.73} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.07, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.73} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      actions: ["check", "bet"],
      hands: [
        { id: "Kb", label: "K♥", equity: 1.00, evUniform: 4.96, evRange: 4.50, rangeWeight: 0.32, freq: {check: 0.17, bet: 0.83}, ev: {check: 4.51, bet: 5.05}, evA: {check: 4.50, bet: 4.50} },
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: -0.52, evRange: -1.37, rangeWeight: 0.31, freq: {check: 0.53, bet: 0.47}, ev: {check: -0.04, bet: -1.06}, evA: {check: -1.37, bet: -1.36} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: -0.52, evRange: -1.37, rangeWeight: 0.31, freq: {check: 0.53, bet: 0.47}, ev: {check: -0.04, bet: -1.06}, evA: {check: -1.37, bet: -1.36} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -1.91, evRange: -1.68, rangeWeight: 0.03, freq: {check: 0.01, bet: 0.99}, ev: {check: -1.78, bet: -1.91}, evA: {check: -1.92, bet: -1.67} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -1.91, evRange: -1.68, rangeWeight: 0.03, freq: {check: 0.01, bet: 0.99}, ev: {check: -1.78, bet: -1.91}, evA: {check: -1.92, bet: -1.67} },
      ],
      children: {
        check: {
      meta: { round: 2, pot: 6, toCall: 0, board: ["K♠"] },
      actions: ["check", "bet"],
      hands: [
        { id: "Kb", label: "K♥", equity: 1.00, evUniform: 7.84, evRange: 5.66, rangeWeight: 0.22, freq: {check: 0.00, bet: 1.00}, ev: {check: 3.00, bet: 7.84}, evA: {check: 2.04, bet: 5.66} },
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: -1.24, evRange: -1.90, rangeWeight: 0.33, freq: {check: 0.63, bet: 0.37}, ev: {check: 0.75, bet: -4.58}, evA: {check: -1.71, bet: -3.22} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: -1.24, evRange: -1.90, rangeWeight: 0.33, freq: {check: 0.63, bet: 0.37}, ev: {check: 0.75, bet: -4.58}, evA: {check: -1.71, bet: -3.22} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -3.11, evRange: -3.32, rangeWeight: 0.07, freq: {check: 0.62, bet: 0.38}, ev: {check: -2.25, bet: -4.52}, evA: {check: -2.93, bet: -4.01} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -3.11, evRange: -3.32, rangeWeight: 0.07, freq: {check: 0.62, bet: 0.38}, ev: {check: -2.25, bet: -4.52}, evA: {check: -2.93, bet: -4.01} },
      ],
      children: {
        check: { terminal: true, outcome: 'showdown' },
        bet: {
      ...
      actions: ["fold", "call", "raise"],
      hands: [
        { id: "Kb", label: "K♥", equity: 1.00, evUniform: 7.00, evRange: 7.01, rangeWeight: 0.32, freq: {fold: 0.00, call: 0.00, raise: 1.00}, ev: {fold: -3.00, call: 7.00, raise: 7.00}, evA: {fold: -3.00, call: 5.49, raise: 7.01} },
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: -0.46, evRange: -1.85, rangeWeight: 0.31, freq: {fold: 0.47, call: 0.53, raise: 0.01}, ev: {fold: -3.00, call: 1.75, raise: 2.50}, evA: {fold: -3.00, call: -2.37, raise: 1.21} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: -0.46, evRange: -1.85, rangeWeight: 0.31, freq: {fold: 0.47, call: 0.53, raise: 0.01}, ev: {fold: -3.00, call: 1.75, raise: 2.50}, evA: {fold: -3.00, call: -2.37, raise: 1.21} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: 2.13, evRange: 2.44, rangeWeight: 0.03, freq: {fold: 0.06, call: 0.00, raise: 0.94}, ev: {fold: -3.00, call: -5.25, raise: 2.48}, evA: {fold: -3.00, call: -6.60, raise: 2.81} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: 2.13, evRange: 2.44, rangeWeight: 0.03, freq: {fold: 0.06, call: 0.00, raise: 0.94}, ev: {fold: -3.00, call: -5.25, raise: 2.48}, evA: {fold: -3.00, call: -6.60, raise: 2.81} },
      ],
      children: {
        fold: { terminal: true, outcome: 'showdown' },
        call: { terminal: true, outcome: 'showdown' },
      ...
      hands: [
        ...
        { id: "Qa", label: "Q♠", equity: 0.63, evUniform: -6.98, evRange: -6.99, rangeWeight: 0.33, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -6.27} },
        { id: "Qb", label: "Q♥", equity: 0.63, evUniform: -6.98, evRange: -6.99, rangeWeight: 0.33, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: 2.75}, evA: {fold: -7.00, call: -6.27} },
        { id: "Ja", label: "J♠", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.07, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.73} },
        { id: "Jb", label: "J♥", equity: 0.13, evUniform: -7.00, evRange: -7.00, rangeWeight: 0.07, freq: {fold: 1.00, call: 0.00}, ev: {fold: -7.00, call: -8.25}, evA: {fold: -7.00, call: -10.73} },
      ],
      children: {
