...
/**
 * Verify the game logic of LeducWithSuitAbstraction is correct.
 */
class VerifyGameLogic : FunSpec({
    ...
    test("Verify terminal states and payoffs") {
        ...
        // Test fold
        val foldState = LeducWithSuitAbstraction(
        ...
        val showdownWin = LeducWithSuitAbstraction(
            p1Card = 4, p2Card = 0, boardCard = 5,  // K♦ vs J♦, board K♥
        ...
        // P0 checks
        state = state.applyAction(com.nlhsolver.core.SimpleGameAction("c", "Check")) as LeducWithSuitAbstraction
    ...
    test("Verify bet/raise mechanics") {
        ...
        state = state.applyAction(com.nlhsolver.core.SimpleGameAction("b", "Bet")) as LeducWithSuitAbstraction
        ...
        state = state.applyAction(com.nlhsolver.core.SimpleGameAction("r", "Raise")) as LeducWithSuitAbstraction
    ...
    test("Verify info set construction") {
        ...
        val preflop1 = LeducWithSuitAbstraction(
            p1Card = 0, p2Card = 2, boardCard = 5,  // J♦ vs Q♦
            round = 1, p1Invested = 1.0, p2Invested = 1.0, history = ""
        )

        val preflop2 = LeducWithSuitAbstraction(
        ...
        val postflop3 = LeducWithSuitAbstraction(
